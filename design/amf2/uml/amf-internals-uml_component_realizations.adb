package body AMF.Internals.UML_Component_Realizations is
   ...
   begin
      ...
      pragma Compile_Time_Warning (Standard.True, "Get_Abstraction unimplemented");
      raise Program_Error with "Unimplemented function Get_Abstraction";
      return Get_Abstraction (Self);
   end Get_Abstraction;
   ...
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Set_Abstraction unimplemented");
      raise Program_Error with "Unimplemented procedure Set_Abstraction";
   end Set_Abstraction;
   ...
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Get_Realizing_Classifier unimplemented");
      raise Program_Error with "Unimplemented function Get_Realizing_Classifier";
      return Get_Realizing_Classifier (Self);
