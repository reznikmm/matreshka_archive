package body AMF.Internals.UML_Deployments is
   ...
   begin
      ...
      raise Program_Error with "Unimplemented function Get_Configuration";
   ...
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Get_Deployed_Artifact unimplemented");
      raise Program_Error with "Unimplemented function Get_Deployed_Artifact";
      return Get_Deployed_Artifact (Self);
   ...
   overriding function Get_Location
     (Self : not null access constant UML_Deployment_Proxy)
      return AMF.UML.Deployment_Targets.UML_Deployment_Target_Access
   is
   begin
      --  Generated stub: replace with real body!
   ...
   overriding procedure Set_Location
     (Self : not null access UML_Deployment_Proxy;
      To   : AMF.UML.Deployment_Targets.UML_Deployment_Target_Access)
   is
   begin
      --  Generated stub: replace with real body!
