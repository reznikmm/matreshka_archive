package body AMF.Internals.UML_Raise_Exception_Actions is
   ...
   begin
      ...
      pragma Compile_Time_Warning (Standard.True, "Get_Exception unimplemented");
      raise Program_Error with "Unimplemented function Get_Exception";
   ...
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Set_Exception unimplemented");
      raise Program_Error with "Unimplemented procedure Set_Exception";
   end Set_Exception;
