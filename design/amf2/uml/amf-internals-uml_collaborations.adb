package body AMF.Internals.UML_Collaborations is
   ...
   begin
      ...
      pragma Compile_Time_Warning (Standard.True, "Get_Collaboration_Role unimplemented");
      raise Program_Error with "Unimplemented function Get_Collaboration_Role";
      return Get_Collaboration_Role (Self);
