package body AMF.Internals.UML_Interface_Realizations is
   ...
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Get_Implementing_Classifier unimplemented");
      raise Program_Error with "Unimplemented function Get_Implementing_Classifier";
      return Get_Implementing_Classifier (Self);
   ...
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Set_Implementing_Classifier unimplemented");
      raise Program_Error with "Unimplemented procedure Set_Implementing_Classifier";
