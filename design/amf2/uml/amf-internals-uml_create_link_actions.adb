package body AMF.Internals.UML_Create_Link_Actions is
   ...
   begin
      ...
      pragma Compile_Time_Warning (Standard.True, "Get_End_Data unimplemented");
      raise Program_Error with "Unimplemented function Get_End_Data";
      return Get_End_Data (Self);
   end Get_End_Data;
   ...
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Get_Input_Value unimplemented");
      raise Program_Error with "Unimplemented function Get_Input_Value";
      return Get_Input_Value (Self);
   end Get_Input_Value;
   ...
   begin
      ...
      raise Program_Error with "Unimplemented function Association";
