package body AMF.Internals.UML_Enumeration_Literals is
   ...
   begin
      ...
      raise Program_Error with "Unimplemented function Get_Enumeration";
   ...
   begin
      ...
      raise Program_Error with "Unimplemented procedure Set_Enumeration";
   end Set_Enumeration;
   ...
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Get_Slot unimplemented");
      raise Program_Error with "Unimplemented function Get_Slot";
      return Get_Slot (Self);
   end Get_Slot;
   ...
   begin
      ...
      raise Program_Error with "Unimplemented function Classifier";
