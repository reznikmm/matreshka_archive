package body AMF.Internals.UML_Accept_Call_Actions is
   ...
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Get_Is_Unmarshall unimplemented");
      raise Program_Error with "Unimplemented function Get_Is_Unmarshall";
      return Get_Is_Unmarshall (Self);
   ...
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Set_Is_Unmarshall unimplemented");
      raise Program_Error with "Unimplemented procedure Set_Is_Unmarshall";
