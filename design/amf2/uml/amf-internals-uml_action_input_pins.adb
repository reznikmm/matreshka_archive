package body AMF.Internals.UML_Action_Input_Pins is
   ...
   begin
      ...
      pragma Compile_Time_Warning (Standard.True, "Get_From_Action unimplemented");
      raise Program_Error with "Unimplemented function Get_From_Action";
      return Get_From_Action (Self);
   end Get_From_Action;
   ...
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Set_From_Action unimplemented");
      raise Program_Error with "Unimplemented procedure Set_From_Action";
   end Set_From_Action;
