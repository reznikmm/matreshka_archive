package body AMF.Internals.UML_Opaque_Expressions is
   ...
   begin
      ...
      raise Program_Error with "Unimplemented function Is_Integral";
   ...
   begin
      ...
      raise Program_Error with "Unimplemented function Is_Non_Negative";
   ...
   begin
      ...
      raise Program_Error with "Unimplemented function Is_Positive";
   ...
   begin
      ...
      raise Program_Error with "Unimplemented function Result";
      return Result (Self);
   end Result;
