package body AMF.Internals.UML_Opaque_Actions is
   ...
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Get_Output_Value unimplemented");
      raise Program_Error with "Unimplemented function Get_Output_Value";
      return Get_Output_Value (Self);
