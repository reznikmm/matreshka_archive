package body AMF.Internals.UML_Instance_Values is
   ...
   begin
      ...
      pragma Compile_Time_Warning (Standard.True, "Get_Instance unimplemented");
      raise Program_Error with "Unimplemented function Get_Instance";
   ...
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Set_Instance unimplemented");
      raise Program_Error with "Unimplemented procedure Set_Instance";
   end Set_Instance;
