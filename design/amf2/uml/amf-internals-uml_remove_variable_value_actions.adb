package body AMF.Internals.UML_Remove_Variable_Value_Actions is
   ...
   overriding procedure Set_Variable
     (Self : not null access UML_Remove_Variable_Value_Action_Proxy;
      To   : AMF.UML.Variables.UML_Variable_Access)
   is
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Set_Variable unimplemented");
      raise Program_Error with "Unimplemented procedure Set_Variable";
   end Set_Variable;
