package body AMF.Internals.UML_Unmarshall_Actions is
   ...
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Get_Unmarshall_Type unimplemented");
      raise Program_Error with "Unimplemented function Get_Unmarshall_Type";
      return Get_Unmarshall_Type (Self);
   ...
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Set_Unmarshall_Type unimplemented");
      raise Program_Error with "Unimplemented procedure Set_Unmarshall_Type";
