package body AMF.Internals.UML_Stereotypes is
   ...
   overriding function Get_Icon
     (Self : not null access constant UML_Stereotype_Proxy)
      return AMF.UML.Images.Collections.Set_Of_UML_Image
   is
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Get_Icon unimplemented");
      raise Program_Error with "Unimplemented function Get_Icon";
   ...
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Get_Profile unimplemented");
      raise Program_Error with "Unimplemented function Get_Profile";
   ...
   begin
      ...
      raise Program_Error with "Unimplemented function Profile";
      return Profile (Self);
   end Profile;
