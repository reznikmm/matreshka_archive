package body AMF.Internals.UML_Destroy_Object_Actions is
   ...
   begin
      ...
      pragma Compile_Time_Warning (Standard.True, "Get_Is_Destroy_Links unimplemented");
      raise Program_Error with "Unimplemented function Get_Is_Destroy_Links";
      return Get_Is_Destroy_Links (Self);
   ...
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Set_Is_Destroy_Links unimplemented");
      raise Program_Error with "Unimplemented procedure Set_Is_Destroy_Links";
   ...
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Get_Is_Destroy_Owned_Objects unimplemented");
      raise Program_Error with "Unimplemented function Get_Is_Destroy_Owned_Objects";
      return Get_Is_Destroy_Owned_Objects (Self);
   ...
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Set_Is_Destroy_Owned_Objects unimplemented");
      raise Program_Error with "Unimplemented procedure Set_Is_Destroy_Owned_Objects";
