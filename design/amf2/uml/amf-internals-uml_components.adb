package body AMF.Internals.UML_Components is
   ...
   begin
      ...
      pragma Compile_Time_Warning (Standard.True, "Get_Is_Indirectly_Instantiated unimplemented");
      raise Program_Error with "Unimplemented function Get_Is_Indirectly_Instantiated";
      return Get_Is_Indirectly_Instantiated (Self);
   ...
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Set_Is_Indirectly_Instantiated unimplemented");
      raise Program_Error with "Unimplemented procedure Set_Is_Indirectly_Instantiated";
   ...
   begin
      ...
      raise Program_Error with "Unimplemented function Realized_Interfaces";
   ...
   begin
      ...
      raise Program_Error with "Unimplemented function Used_Interfaces";
