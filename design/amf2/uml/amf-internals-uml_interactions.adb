package body AMF.Internals.UML_Interactions is
   ...
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Get_Formal_Gate unimplemented");
      raise Program_Error with "Unimplemented function Get_Formal_Gate";
      return Get_Formal_Gate (Self);
   end Get_Formal_Gate;
   ...
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Get_Lifeline unimplemented");
      raise Program_Error with "Unimplemented function Get_Lifeline";
      return Get_Lifeline (Self);
   end Get_Lifeline;
