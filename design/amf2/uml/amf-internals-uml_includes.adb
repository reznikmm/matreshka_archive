package body AMF.Internals.UML_Includes is
   ...
   begin
      ...
      pragma Compile_Time_Warning (Standard.True, "Get_Addition unimplemented");
      raise Program_Error with "Unimplemented function Get_Addition";
      return Get_Addition (Self);
   end Get_Addition;
   ...
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Set_Addition unimplemented");
      raise Program_Error with "Unimplemented procedure Set_Addition";
   end Set_Addition;
   ...
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Get_Including_Case unimplemented");
      raise Program_Error with "Unimplemented function Get_Including_Case";
      return Get_Including_Case (Self);
   ...
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Set_Including_Case unimplemented");
      raise Program_Error with "Unimplemented procedure Set_Including_Case";
