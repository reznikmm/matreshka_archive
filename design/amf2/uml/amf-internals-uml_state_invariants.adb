package body AMF.Internals.UML_State_Invariants is
   ...
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Get_Invariant unimplemented");
      raise Program_Error with "Unimplemented function Get_Invariant";
      return Get_Invariant (Self);
   end Get_Invariant;
   ...
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Set_Invariant unimplemented");
      raise Program_Error with "Unimplemented procedure Set_Invariant";
   end Set_Invariant;
