package body AMF.Internals.UML_Decision_Nodes is
   ...
   begin
      ...
      pragma Compile_Time_Warning (Standard.True, "Get_Decision_Input unimplemented");
      raise Program_Error with "Unimplemented function Get_Decision_Input";
      return Get_Decision_Input (Self);
   ...
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Set_Decision_Input unimplemented");
      raise Program_Error with "Unimplemented procedure Set_Decision_Input";
   ...
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Get_Decision_Input_Flow unimplemented");
      raise Program_Error with "Unimplemented function Get_Decision_Input_Flow";
      return Get_Decision_Input_Flow (Self);
   ...
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Set_Decision_Input_Flow unimplemented");
      raise Program_Error with "Unimplemented procedure Set_Decision_Input_Flow";
