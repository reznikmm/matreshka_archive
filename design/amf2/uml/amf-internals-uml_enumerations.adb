package body AMF.Internals.UML_Enumerations is
   ...
   overriding function Get_Owned_Literal
     (Self : not null access constant UML_Enumeration_Proxy)
      return AMF.UML.Enumeration_Literals.Collections.Ordered_Set_Of_UML_Enumeration_Literal
   is
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Get_Owned_Literal unimplemented");
      raise Program_Error with "Unimplemented function Get_Owned_Literal";
