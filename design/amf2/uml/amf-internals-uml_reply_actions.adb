package body AMF.Internals.UML_Reply_Actions is
   ...
   begin
      ...
      pragma Compile_Time_Warning (Standard.True, "Get_Reply_To_Call unimplemented");
      raise Program_Error with "Unimplemented function Get_Reply_To_Call";
      return Get_Reply_To_Call (Self);
   ...
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Set_Reply_To_Call unimplemented");
      raise Program_Error with "Unimplemented procedure Set_Reply_To_Call";
   ...
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Get_Reply_Value unimplemented");
      raise Program_Error with "Unimplemented function Get_Reply_Value";
      return Get_Reply_Value (Self);
   end Get_Reply_Value;
   ...
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Get_Return_Information unimplemented");
      raise Program_Error with "Unimplemented function Get_Return_Information";
      return Get_Return_Information (Self);
   ...
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Set_Return_Information unimplemented");
      raise Program_Error with "Unimplemented procedure Set_Return_Information";
