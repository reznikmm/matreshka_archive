package body AMF.Internals.UML_Interruptible_Activity_Regions is
   ...
   begin
      ...
      pragma Compile_Time_Warning (Standard.True, "Get_Interrupting_Edge unimplemented");
      raise Program_Error with "Unimplemented function Get_Interrupting_Edge";
      return Get_Interrupting_Edge (Self);
