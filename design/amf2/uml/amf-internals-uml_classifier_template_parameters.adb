package body AMF.Internals.UML_Classifier_Template_Parameters is

   -----------------------------
   -- Get_Allow_Substitutable --
   -----------------------------
   ...
   begin
      ...
      pragma Compile_Time_Warning (Standard.True, "Get_Allow_Substitutable unimplemented");
      raise Program_Error with "Unimplemented function Get_Allow_Substitutable";
      return Get_Allow_Substitutable (Self);
   end Get_Allow_Substitutable;

   -----------------------------
   -- Set_Allow_Substitutable --
   -----------------------------
   ...
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Set_Allow_Substitutable unimplemented");
      raise Program_Error with "Unimplemented procedure Set_Allow_Substitutable";
   end Set_Allow_Substitutable;

   ---------------------------------
   -- Get_Constraining_Classifier --
   ---------------------------------
   ...
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Get_Constraining_Classifier unimplemented");
      raise Program_Error with "Unimplemented function Get_Constraining_Classifier";
      return Get_Constraining_Classifier (Self);
