package body AMF.Internals.UML_Change_Events is
   ...
   begin
      ...
      pragma Compile_Time_Warning (Standard.True, "Get_Change_Expression unimplemented");
      raise Program_Error with "Unimplemented function Get_Change_Expression";
      return Get_Change_Expression (Self);
   ...
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Set_Change_Expression unimplemented");
      raise Program_Error with "Unimplemented procedure Set_Change_Expression";
