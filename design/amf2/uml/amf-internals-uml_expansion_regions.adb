package body AMF.Internals.UML_Expansion_Regions is
   ...
   overriding function Get_Input_Element
     (Self : not null access constant UML_Expansion_Region_Proxy)
      return AMF.UML.Expansion_Nodes.Collections.Set_Of_UML_Expansion_Node
   is
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Get_Input_Element unimplemented");
      raise Program_Error with "Unimplemented function Get_Input_Element";
      return Get_Input_Element (Self);
   ...
   begin
      ...
      raise Program_Error with "Unimplemented function Get_Mode";
   ...
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Get_Output_Element unimplemented");
      raise Program_Error with "Unimplemented function Get_Output_Element";
      return Get_Output_Element (Self);
