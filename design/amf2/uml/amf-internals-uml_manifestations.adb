package body AMF.Internals.UML_Manifestations is
   ...
   begin
      ...
      pragma Compile_Time_Warning (Standard.True, "Get_Utilized_Element unimplemented");
      raise Program_Error with "Unimplemented function Get_Utilized_Element";
      return Get_Utilized_Element (Self);
   ...
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Set_Utilized_Element unimplemented");
      raise Program_Error with "Unimplemented procedure Set_Utilized_Element";
   ...
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Get_Mapping unimplemented");
      raise Program_Error with "Unimplemented function Get_Mapping";
   ...
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Set_Mapping unimplemented");
      raise Program_Error with "Unimplemented procedure Set_Mapping";
   end Set_Mapping;
