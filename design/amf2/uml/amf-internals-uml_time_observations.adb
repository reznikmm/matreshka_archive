package body AMF.Internals.UML_Time_Observations is
   ...
   begin
      ...
      raise Program_Error with "Unimplemented function Get_Event";
      return Get_Event (Self);
   end Get_Event;
   ...
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Set_Event unimplemented");
      raise Program_Error with "Unimplemented procedure Set_Event";
   end Set_Event;
   ...
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Get_First_Event unimplemented");
      raise Program_Error with "Unimplemented function Get_First_Event";
   ...
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Set_First_Event unimplemented");
      raise Program_Error with "Unimplemented procedure Set_First_Event";
   end Set_First_Event;
