package body AMF.Internals.UML_Time_Expressions is
   ...
   begin
      ...
      pragma Compile_Time_Warning (Standard.True, "Get_Expr unimplemented");
      raise Program_Error with "Unimplemented function Get_Expr";
      return Get_Expr (Self);
   end Get_Expr;
   ...
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Set_Expr unimplemented");
      raise Program_Error with "Unimplemented procedure Set_Expr";
   end Set_Expr;
   ...
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Get_Observation unimplemented");
      raise Program_Error with "Unimplemented function Get_Observation";
