package body AMF.Internals.UML_Reduce_Actions is
   ...
   begin
      ...
      pragma Compile_Time_Warning (Standard.True, "Get_Collection unimplemented");
      raise Program_Error with "Unimplemented function Get_Collection";
      return Get_Collection (Self);
   end Get_Collection;
   ...
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Set_Collection unimplemented");
      raise Program_Error with "Unimplemented procedure Set_Collection";
   end Set_Collection;
   ...
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Get_Reducer unimplemented");
      raise Program_Error with "Unimplemented function Get_Reducer";
      return Get_Reducer (Self);
   end Get_Reducer;
   ...
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Set_Reducer unimplemented");
      raise Program_Error with "Unimplemented procedure Set_Reducer";
   end Set_Reducer;
