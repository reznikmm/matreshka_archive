package body AMF.Internals.UML_Protocol_Transitions is
   ...
   begin
      ...
      pragma Compile_Time_Warning (Standard.True, "Get_Post_Condition unimplemented");
      raise Program_Error with "Unimplemented function Get_Post_Condition";
      return Get_Post_Condition (Self);
   ...
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Set_Post_Condition unimplemented");
      raise Program_Error with "Unimplemented procedure Set_Post_Condition";
   ...
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Get_Pre_Condition unimplemented");
      raise Program_Error with "Unimplemented function Get_Pre_Condition";
      return Get_Pre_Condition (Self);
   ...
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Set_Pre_Condition unimplemented");
      raise Program_Error with "Unimplemented procedure Set_Pre_Condition";
   ...
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Get_Referred unimplemented");
      raise Program_Error with "Unimplemented function Get_Referred";
      return Get_Referred (Self);
   end Get_Referred;
   ...
   begin
      ...
      raise Program_Error with "Unimplemented function Referred";
