package body AMF.Internals.UML_Devices is
   ...
   overriding function Get_Nested_Node
     (Self : not null access constant UML_Device_Proxy)
      return AMF.UML.Nodes.Collections.Set_Of_UML_Node
   is
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Get_Nested_Node unimplemented");
      raise Program_Error with "Unimplemented function Get_Nested_Node";
      return Get_Nested_Node (Self);
   end Get_Nested_Node;
