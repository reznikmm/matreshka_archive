package body AMF.Internals.UML_Activity_Parameter_Nodes is
   ...
   overriding procedure Set_Parameter
     (Self : not null access UML_Activity_Parameter_Node_Proxy;
      To   : AMF.UML.Parameters.UML_Parameter_Access)
   is
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Set_Parameter unimplemented");
      raise Program_Error with "Unimplemented procedure Set_Parameter";
   end Set_Parameter;
