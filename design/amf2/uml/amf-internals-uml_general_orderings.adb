package body AMF.Internals.UML_General_Orderings is
   ...
   begin
      ...
      pragma Compile_Time_Warning (Standard.True, "Get_After unimplemented");
      raise Program_Error with "Unimplemented function Get_After";
      return Get_After (Self);
   end Get_After;
   ...
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Set_After unimplemented");
      raise Program_Error with "Unimplemented procedure Set_After";
   end Set_After;
   ...
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Get_Before unimplemented");
      raise Program_Error with "Unimplemented function Get_Before";
      return Get_Before (Self);
   end Get_Before;
   ...
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Set_Before unimplemented");
      raise Program_Error with "Unimplemented procedure Set_Before";
   end Set_Before;
