package body AMF.Internals.UML_Information_Items is
   ...
   begin
      ...
      pragma Compile_Time_Warning (Standard.True, "Get_Represented unimplemented");
      raise Program_Error with "Unimplemented function Get_Represented";
      return Get_Represented (Self);
   end Get_Represented;
