package body AMF.Internals.UML_Read_Is_Classified_Object_Actions is
   ...
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Get_Is_Direct unimplemented");
      raise Program_Error with "Unimplemented function Get_Is_Direct";
      return Get_Is_Direct (Self);
   end Get_Is_Direct;
   ...
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Set_Is_Direct unimplemented");
      raise Program_Error with "Unimplemented procedure Set_Is_Direct";
   end Set_Is_Direct;
