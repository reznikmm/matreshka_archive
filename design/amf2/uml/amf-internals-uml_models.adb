package body AMF.Internals.UML_Models is
   ...
   begin
      ...
      pragma Compile_Time_Warning (Standard.True, "Get_Viewpoint unimplemented");
      raise Program_Error with "Unimplemented function Get_Viewpoint";
      return Get_Viewpoint (Self);
   end Get_Viewpoint;
   ...
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Set_Viewpoint unimplemented");
      raise Program_Error with "Unimplemented procedure Set_Viewpoint";
   end Set_Viewpoint;
