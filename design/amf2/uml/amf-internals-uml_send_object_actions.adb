package body AMF.Internals.UML_Send_Object_Actions is
   ...
   begin
      ...
      pragma Compile_Time_Warning (Standard.True, "Get_Request unimplemented");
      raise Program_Error with "Unimplemented function Get_Request";
   ...
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Set_Request unimplemented");
      raise Program_Error with "Unimplemented procedure Set_Request";
   end Set_Request;
