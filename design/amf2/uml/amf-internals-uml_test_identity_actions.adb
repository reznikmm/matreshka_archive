package body AMF.Internals.UML_Test_Identity_Actions is
   ...
   begin
      ...
      pragma Compile_Time_Warning (Standard.True, "Get_First unimplemented");
   ...
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Set_First unimplemented");
      raise Program_Error with "Unimplemented procedure Set_First";
   end Set_First;
   ...
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Get_Second unimplemented");
      raise Program_Error with "Unimplemented function Get_Second";
      return Get_Second (Self);
   end Get_Second;
   ...
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Set_Second unimplemented");
      raise Program_Error with "Unimplemented procedure Set_Second";
   end Set_Second;
