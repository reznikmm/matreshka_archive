package body AMF.Internals.UML_Expansion_Nodes is
   ...
   begin
      ...
      pragma Compile_Time_Warning (Standard.True, "Get_Region_As_Input unimplemented");
      raise Program_Error with "Unimplemented function Get_Region_As_Input";
      return Get_Region_As_Input (Self);
   ...
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Set_Region_As_Input unimplemented");
      raise Program_Error with "Unimplemented procedure Set_Region_As_Input";
   ...
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Get_Region_As_Output unimplemented");
      raise Program_Error with "Unimplemented function Get_Region_As_Output";
      return Get_Region_As_Output (Self);
   ...
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Set_Region_As_Output unimplemented");
      raise Program_Error with "Unimplemented procedure Set_Region_As_Output";
