package body AMF.Internals.UML_Use_Cases is
   ...
   begin
      ...
      pragma Compile_Time_Warning (Standard.True, "Get_Extend unimplemented");
      raise Program_Error with "Unimplemented function Get_Extend";
      return Get_Extend (Self);
   end Get_Extend;
   ...
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Get_Extension_Point unimplemented");
      raise Program_Error with "Unimplemented function Get_Extension_Point";
      return Get_Extension_Point (Self);
   ...
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Get_Include unimplemented");
      raise Program_Error with "Unimplemented function Get_Include";
      return Get_Include (Self);
   end Get_Include;
   ...
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Get_Subject unimplemented");
      raise Program_Error with "Unimplemented function Get_Subject";
      return Get_Subject (Self);
   end Get_Subject;
   ...
   begin
      ...
      raise Program_Error with "Unimplemented function All_Included_Use_Cases";
