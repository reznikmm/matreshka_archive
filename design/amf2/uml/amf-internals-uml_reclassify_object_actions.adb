package body AMF.Internals.UML_Reclassify_Object_Actions is
   ...
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Get_New_Classifier unimplemented");
      raise Program_Error with "Unimplemented function Get_New_Classifier";
      return Get_New_Classifier (Self);
   ...
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Get_Old_Classifier unimplemented");
      raise Program_Error with "Unimplemented function Get_Old_Classifier";
      return Get_Old_Classifier (Self);
