package body AMF.Internals.UML_Collaboration_Uses is
   ...
   begin
      ...
      pragma Compile_Time_Warning (Standard.True, "Get_Role_Binding unimplemented");
      raise Program_Error with "Unimplemented function Get_Role_Binding";
      return Get_Role_Binding (Self);
