package body AMF.Internals.UML_Join_Nodes is
   ...
   begin
      ...
      pragma Compile_Time_Warning (Standard.True, "Get_Is_Combine_Duplicate unimplemented");
      raise Program_Error with "Unimplemented function Get_Is_Combine_Duplicate";
      return Get_Is_Combine_Duplicate (Self);
   ...
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Set_Is_Combine_Duplicate unimplemented");
      raise Program_Error with "Unimplemented procedure Set_Is_Combine_Duplicate";
   ...
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Get_Join_Spec unimplemented");
      raise Program_Error with "Unimplemented function Get_Join_Spec";
      return Get_Join_Spec (Self);
   end Get_Join_Spec;
   ...
   begin
      --  Generated stub: replace with real body!
      pragma Compile_Time_Warning (Standard.True, "Set_Join_Spec unimplemented");
      raise Program_Error with "Unimplemented procedure Set_Join_Spec";
   end Set_Join_Spec;
