...
package body CMOF.Internals.Reflection is
   ...
   is
      --------------------------
      -- Get_CMOF_Enumeration --
      --------------------------

      function Get_CMOF_Enumeration return AMF.Values.Value is
      begin
      ...
      end Get_CMOF_Enumeration;

      ----------------------
      -- Get_CMOF_Package --
      ----------------------

      function Get_CMOF_Package return AMF.Values.Value is
      begin
         if Property = MP_Cmof_Named_Element_Name then
            return
             (AMF.Values.Value_String,
